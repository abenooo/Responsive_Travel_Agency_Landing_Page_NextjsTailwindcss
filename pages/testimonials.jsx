...
function testimonials() {
  return (
    <div>
      <section class="max-w6xl mx-auto px-4 lg-px-6 py-12">
        <div class="w-full text-center pb-8">
          ...
          <h1 class="font-bold text-3xl md-text-4xl lg-text-5xl font-heading text-gray-500 pb-2">
            Find someone testimonials about us
          </h1>
          <p class="text-gray-500 font-normal text-base">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione error libero maiores molestias quia
            nostrum, eaque labore nisi optio architecto recusandae tenetur? Illo eligendi quo minus, quae ea tempora
            accusantium!
          </p>
        </div>

        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:px-14 gap-6">
          <div class="bg-white rounded-lg p-6">
            <div class="flex items-center space-x-6 mb-4">
              <g-image
                class="h-28 w-28 object-cover object-center rounded-full"
                src="https://images.unsplash.com/photo-1635407640793-72dd329d218a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
                alt="photo"></g-image>
              <div>
                <p class="text-xl text-gray-700 font-normal mb-1">Romeo Oscar</p>
                <p class="text-base text-blue-700 font-normal">Dev Ops</p>
              </div>
            </div>
            <div>
              <p class="text-gray-400 leading-loose ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem aspernatur ad repellendus magnam
                provident dolores consectetur nemo sapiente a totam, deleniti recusandae quasi distinctio hic nesciunt.
                Quam pariatur officia odio?
              </p>
            </div>
          </div>
          <div class="bg-white rounded-lg p-6">
            <div class="flex items-center space-x-6 mb-4">
              <g-image
                ...
                alt="photo"></g-image>
              <div>
                <p class="text-xl text-gray-700 font-normal mb-1">Lemmac Charle</p>
          ...
          <div class="bg-white rounded-lg p-6">
            <div class="flex items-center space-x-6 mb-4">
              <g-image
                class="h-28 w-28 object-cover object-center rounded-full"
                src="https://images.unsplash.com/photo-1518818608552-195ed130cdf4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                alt="photo"></g-image>
              <div>
                <p class="text-xl text-gray-700 font-normal mb-1">Alepha Kilo</p>
                <p class="text-base text-blue-600 font-normal">Softwarw Enginner</p>
              </div>
            </div>
            <div>
              <p class="text-gray-400 leading-loose font-normal text-base">
          ...
          <div class="bg-white rounded-lg p-6">
            <div class="flex items-center space-x-6 mb-4">
              <g-image
                class="h-28 w-28 object-cover object-center rounded-full"
                src="https://images.unsplash.com/photo-1535551951406-a19828b0a76b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1466&q=80"
                alt="photo"></g-image>
              <div>
                <p class="text-xl text-gray-700 font-normal mb-1">Deleta Eko</p>
                <p class="text-base text-blue-600 font-normal">Graphic Designer</p>
              </div>
            </div>
            <div>
