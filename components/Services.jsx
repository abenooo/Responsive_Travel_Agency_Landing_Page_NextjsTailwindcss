    ...
    <div className="my-40 mx-10 md:mx-auto ">
      ...
      <div className="mt-10 mb-10 flex flex-col items-center justify-center">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 ">
          <div className="group flex h-16 w-auto cursor-pointer items-center justify-center gap-8 rounded-xl border border-gray-600 px-8 hover:bg-gray-600 hover:shadow-xl ">
          ...
          <div className="group flex h-16 w-auto cursor-pointer items-center justify-center gap-8 rounded-xl border border-violet-600 px-8 hover:bg-gray-600 hover:shadow-xl ">
            <GiCampfire className="text-2xl text-gray-600 group-hover:text-white" />
            <h1 className="text-xl font-semibold text-violet-600 group-hover:text-white">
              Camping
            </h1>
